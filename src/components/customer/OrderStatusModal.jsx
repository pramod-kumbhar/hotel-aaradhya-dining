...
import { Clock, CheckCircle2, ChefHat, UtensilsCrossed, X, ShieldAlert, Sparkles, Edit3 } from 'lucide-react';
    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/85 backdrop-blur-md animate-fade-in">
        <div className="bg-stone-900 border border-amber-600/40 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-5 relative overflow-hidden">
          ...
          {/* Action Buttons: Edit Order & Close */}
          <div className="flex gap-2">
            <button
              onClick={() => setIsEditModalOpen(true)}
              className="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-stone-950 font-black text-xs flex items-center justify-center gap-1.5 shadow-lg shadow-orange-950/40 hover:scale-[1.02] transition"
            >
              <Edit3 className="w-4 h-4" />
              <span>{lang === 'mr' ? '✏️ ऑर्डर बदला / पदार्थ जोडा' : '✏️ Edit Order / Add Items'}</span>
            </button>
